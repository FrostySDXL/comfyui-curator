...
| `tests/unit/test_frontend_keyboard_focus.py`, `keyboard_focus_lifecycle_test.js` | Real-source modal/lightbox keyboard isolation, visible focus wrapping, nested opener restoration, and typing-target protection | Python wrapper executes the ordered frontend focus/keyboard sources in a Node VM |
